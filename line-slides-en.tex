...
%\documentclass[noamsthm,notheorems,11pt,compress,aspectratio=169]{beamer}


%--------- Beamer theme ----------
\usetheme[en]{LineSlides}
% language: cn, en
% color theme: red, light, deep, dark
...
\institute[NU]{\vskip -10pt \small \blue{Name of University} \\ % Institution
\medskip
\texttt{xyz@math.univ.edu} % Email address
}

\date[July 28, 2022]{\small Very Large Conference \\[5pt] July 28, 2022}
...
%\Huge\bfseries\textcolor{structure.fg}{The End}
\end{center}
\end{frame}
