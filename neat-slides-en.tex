...
\author[John Smith]{John Smith \\[5pt] \textit{xyz@math.univ.edu} }% Your email address} % Your name
\institute[NU] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{\vspace{-8pt}\blue{Name of University} \\[15pt] % Your institution for the title page
\small Very Large Conference \\[5pt] July 28, 2022
}
